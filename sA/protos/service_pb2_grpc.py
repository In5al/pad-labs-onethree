...
class UserServiceStub(object):
    ...
    def __init__(self, channel):
        ...
        self.GetUserScore = channel.unary_unary(
                '/service_a.UserService/GetUserScore',
        ...
        self.UpdateUserScore = channel.unary_unary(
                '/service_a.UserService/UpdateUserScore',
                request_serializer=service__pb2.UpdateScoreRequest.SerializeToString,
...
def add_UserServiceServicer_to_server(servicer, server):
    rpc_method_handlers = {
            ...
            'UpdateUserScore': grpc.unary_unary_rpc_method_handler(
                    servicer.UpdateUserScore,
                    request_deserializer=service__pb2.UpdateScoreRequest.FromString,
                    response_serializer=service__pb2.UpdateResponse.SerializeToString,
            ),
    }
    generic_handler = grpc.method_handlers_generic_handler(
            'service_a.UserService', rpc_method_handlers)
    server.add_generic_rpc_handlers((generic_handler,))
    server.add_registered_method_handlers('service_a.UserService', rpc_method_handlers)
...
class UserService(object):
    ...
    def GetUserScore(request,
        ...
        return grpc.experimental.unary_unary(
            ...
            service__pb2.ScoreResponse.FromString,
            options,
            channel_credentials,
            insecure,
            call_credentials,
    ...
    def UpdateUserScore(request,
        ...
        return grpc.experimental.unary_unary(
            ...
            target,
            '/service_a.UserService/UpdateUserScore',
            service__pb2.UpdateScoreRequest.SerializeToString,
